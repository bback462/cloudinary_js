...
var Cloudinary = class Cloudinary {
  ...
  *   Should only be used if the transformation supports different aspect ratios.
  ...
  cloudinary_update(elements, options) {
    ...
    let responsiveClass =
      (this.responsiveConfig && this.responsiveConfig.responsive_class != null) ? this.responsiveConfig.responsive_class :
      options.responsive_class != null ?  options.responsive_class :
